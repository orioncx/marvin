...
class LevelManager:
    ...
    def set_level(self, lid, lnum, task, hints, opened_penalty_hints, closed_bonuses, closed_sectors,
                         unclosed_sect_count, answ_en, all_timers, up_time_seconds):
...
class EnWatcher:
    ...
    def input_answer(self, answer):
        ...
        elif r.text.find('color_correct') != -1:
    ...
    def game_refresh(self):
        ...
        if len(sectors_cont):
            ...
            unclosed_sect_text = page.cssselect('h3 .color_sec')[0].text_content()
            unclosed_sect_count = int(unclosed_sect_text[unclosed_sect_text.rfind(' ') + 1:-1])
